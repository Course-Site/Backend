...
export class LabResultController {
  ...
  @ApiResponse({ status: 201, description: 'The labresult has been successfully created.' })
  ...
  @ApiResponse({ status: 200, description: 'Return the labresult with the given ID.' })
  ...
  @ApiParam({ name: 'id', description: 'LabResult ID', type: 'string' })
  @ApiResponse({ status: 200, description: 'The labresult has been successfully deleted.' })
  @ApiResponse({ status: 404, description: 'LabResult not found.' })
