...
export class LabController {
  ...
  @ApiResponse({ status: 201, description: 'The lab has been successfully created.' })
  ...
  @ApiResponse({ status: 200, description: 'Return the lab with the given ID.' })
  ...
  @ApiParam({ name: 'id', description: 'Lab ID', type: 'string' })
  @ApiResponse({ status: 200, description: 'The lab has been successfully deleted.' })
  @ApiResponse({ status: 404, description: 'Lab not found.' })
