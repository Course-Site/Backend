...
export class TestResultController {
  ...
  @ApiResponse({ status: 201, description: 'The testresult has been successfully created.' })
  ...
  @ApiResponse({ status: 200, description: 'Return the testresult with the given ID.' })
  ...
  @ApiResponse({ status: 200, description: 'testresult data has been changed.' })
  @ApiResponse({ status: 404, description: 'TestResult not found.' })
  ...
  @ApiParam({ name: 'id', description: 'TestResult ID', type: 'string' })
  @ApiResponse({ status: 200, description: 'The testresult has been successfully deleted.' })
  @ApiResponse({ status: 404, description: 'TestResult not found.' })
